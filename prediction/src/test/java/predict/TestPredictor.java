...
5 = {HashMap$Node@2460} "[ltake, rfood]=[false x 6]" ==========> red herring, parasitic stats !!!
    ...
    void test6() {
        ...
        // predicting 'rhand_food' in two_registers world
        String historyStr = "{[rtake, lrock, lhand_rock, rhand_rock]=[false], [ltake, lhand_rock, rrock, rhand_rock]=[false], [rfwd, lhand_rock, rrock, rhand_rock]=[false], [rtake, lrock, rrock]=[false], [rfwd, lrock, rrock, rhand_rock]=[false x 2], [rtake]=[false x 2], [rfwd, lrock, lhand_rock, rrock]=[false], [ltake, lrock]=[false], [ltake, lrock, lhand_rock, rrock]=[false x 2], [ltake, lrock, rfood, rhand_rock]=[false], [rtake, lhand_rock, rrock]=[false], [rfwd, lrock]=[false], [rfwd, rhand_rock]=[false], [lfwd, lfood, lhand_rock, rrock, rhand_food]=[true], [leat, lhand_rock, rfood, rhand_rock]=[false], [lfwd, lrock, lhand_rock]=[false x 3], [rfwd, lrock, lhand_rock, rfood]=[false], [leat, lhand_rock, rhand_rock]=[false], [rtake, rrock, rhand_rock]=[false x 2], [rtake, lfood, lhand_rock, rhand_rock]=[false], [ltake, lhand_rock, rhand_rock]=[false], [lfwd, lhand_rock, rfood]=[false], [rtake, rrock]=[false x 2], [lfwd, lfood, lhand_rock]=[false], [lfwd, lhand_rock, rrock]=[false], [rtake, rhand_rock]=[false x 3], [lfwd, rrock]=[false], [ltake, rrock, rhand_rock]=[false x 2], [rfwd]=[false x 2], [lfwd, lrock, rhand_rock]=[false], [lfwd, lhand_rock, rhand_rock]=[false], [ltake, lrock, rrock, rhand_rock]=[false], [lfwd, rhand_rock]=[false], [leat, rrock, rhand_rock]=[false], [lfwd, lhand_food]=[false], [reat, lrock, rhand_rock]=[false], [lfwd, lhand_rock, rfood, rhand_food]=[true], [reat, lfood, lhand_rock]=[false], [ltake, lrock, rrock]=[false], [ltake, lrock, rfood]=[false], [ltake, lhand_rock, rrock]=[false], [rtake, lrock, lhand_rock]=[false], [rfwd, lhand_rock, rfood]=[false], [rtake, lrock, lhand_rock, rrock]=[false], [ltake, lrock, lhand_rock, rrock, rhand_food]=[true], [lfwd, lrock, rrock, rhand_rock]=[false], [rtake, lhand_rock]=[false], [ltake]=[false x 4], [rfwd, lfood, lhand_rock, rfood, rhand_food]=[true], [rfwd, rrock, rhand_rock]=[false x 2], [leat]=[false x 2], [ltake, lrock, lhand_food]=[false], [ltake, lfood, lhand_rock]=[false], [rfwd, lrock, lhand_rock]=[false], [rfwd, lhand_rock, rhand_food]=[true], [leat, lrock]=[false], [rfwd, lrock, rhand_rock]=[false x 2], [rfwd, rrock]=[false], [leat, rrock]=[false], [rfwd, lrock, rrock]=[false], [rtake, lhand_rock, rrock, rhand_food]=[false], [rtake, lhand_rock, rfood, rhand_rock]=[true], [lfwd]=[false x 2], [ltake, lhand_rock]=[false], [reat, lrock, rrock, rhand_rock]=[false]}";
        loadHistory(p, historyStr);
        List<Prediction<String>> predictions = p.predict(Set.of("lhand_rock","rfwd"));
        assertSingle("false", predictions); // must be no 'rhand_food'

//        0 = {HashMap$Node@2321} "[rfwd]=[false x 17, true x 2]"
//        1 = {HashMap$Node@2322} "[lhand_rock]=[false x 29, true x 6]"
//        2 = {HashMap$Node@2323} "[rfwd, lhand_rock]=[false x 5, true x 2]"
    }

    private void loadHistory(Predictor<String> p, String historyStr) {
